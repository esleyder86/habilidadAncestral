              ...
              <form @submit.prevent="onSignin">
                ...
                <v-layout row>
                  <v-flex xs12>
                    ...
                    <div class="text-xs-center">
                      <v-btn round color="red" dark :disabled="loading" :loading="loading" @click.prevent="onSigninGoogle">Ingresa con Google
...
<script>
  export default {
    ...
    methods: {
      ...
      onResetPassword () {
        if (this.email === '') {
          return this.$store.dispatch('setError', {message: 'El correo no puede estar vacio'})
        }
